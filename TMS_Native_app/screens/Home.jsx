...
import { Text, Button, Card, CardImage, List, ListItem, TextInput, IconButton, BottomNavigation, TabView, TabBar } from 'react-native-paper';
...
export default function Home() {
    ...
    const renderContent = () => {
        switch (selectedTab) {
            case 'packages':
                return <PopularPackages packages={packages} />;
            case 'city':
                return <PopularCity packages={packages} />;
            case 'hotels':
                return <PopularHotels packages={packages} />;
            default:
                return null;
        }
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.navBar}>
                <TouchableOpacity onPress={() => setSelectedTab('packages')}>
                    <Text style={selectedTab === 'packages' ? styles.navBarItemActive : styles.navBarItem}>Popular Packages</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setSelectedTab('city')}>
                    <Text style={selectedTab === 'city' ? styles.navBarItemActive : styles.navBarItem}>Popular City</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setSelectedTab('hotels')}>
                    <Text style={selectedTab === 'hotels' ? styles.navBarItemActive : styles.navBarItem}>Popular Hotels</Text>
                </TouchableOpacity>
            </View>
            {renderContent()}
